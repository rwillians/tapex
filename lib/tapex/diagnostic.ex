defmodule Tapex.Diagnostic do
  ...
  defp formatter(:error_info, msg, color), do: color_wrap(msg, :red, color)
  defp formatter(:extra_info, msg, color), do: color_wrap(msg, :cyan, color)
  defp formatter(:location_info, msg, color), do: color_wrap(msg, [:bright, :black], color)
  defp formatter(:diff_delete, msg, color), do: color_wrap(msg, :red, color)
  defp formatter(:diff_insert, msg, color), do: color_wrap(msg, :green, color)
