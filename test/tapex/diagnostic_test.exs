defmodule Tapex.DiagnosticTest do
  ...
  test "format_diagnostic for test without color" do
    trace = [{Tapex, :awesome, 1, [file: ~c"awesome.ex", line: 42]}]
    ...
    expected =
      "#       2) everything is awesome (nil)\n" <>
        ...
        "#          code: \"Awesum!()\"\n" <>
        "#          stacktrace:\n" <>
        "#            (tapex 0.1.2) awesome.ex:42: Tapex.awesome/1"
  ...
  test "format_diagnostic for TestCase with color" do
    ...
    trace = [{Tapex, :my_method, 1, [file: ~c"my_module.ex", line: 20]}]
    ...
    expected =
      "#       5) nil: failure on setup_all callback, all tests have been invalidated\n" <>
        ...
        "#            (tapex 0.1.2) my_module.ex:20: Tapex.my_method/1"
